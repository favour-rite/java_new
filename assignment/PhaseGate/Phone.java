...
public class Phone {
    ...
    static class Contact {
        ...
        Contact(String name, String phoneNumber, String pin) {
            this.name = name;
    ...
    public static void addContact() {
        ...
        contacts.add(new Contact(name, phoneNumber, pin));
    ...
    public static void searchByName() {
        ...
        for (Contact contact : contacts) {
            if (contact.name.equalsIgnoreCase(name)) {
                System.out.println("Found Contact: " + contact.name + " : " + contact.phoneNumber);
                found = true;
                break;
            }
        }
